...
mod tests {
          ...
          "assets": [
            {
              ...
              "size": 1,
              "githubUrl": "https://github.com/vivalucas/mininote/releases/download/v1.0.5/asset.zip"
            }
          ]
        }"#;
    ...
    fn selects_windows_nsis_asset() {
        ...
        assert_eq!(asset.name, "mininote_1.0.5_windows_x64_nsis.exe");
    }
    ...
    fn selects_windows_portable_asset() {
        ...
        assert_eq!(asset.name, "mininote_1.0.5_windows_x64_portable.exe");
    }
    ...
    fn selects_macos_aarch64_asset() {
        ...
        assert_eq!(asset.name, "mininote_1.0.5_macos_aarch64_app.zip");
    }
