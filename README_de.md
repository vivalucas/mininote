...
- **Import und Export**: Unterstützt `.mint`, `.md`, `.markdown` und `.txt`.
- **Schutz beim Abgleich mit Quelldateien**: Importierte Dateien können ihre Quelle behalten; MiniNote prüft externe Änderungen, bevor es zurückschreibt.
